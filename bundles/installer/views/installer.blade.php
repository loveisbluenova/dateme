...
<h5 class="antagon-color-main">Welcome to DateMe Blaze Installer</h5> - This will install <span class="text-berry">{{ Config::get('installer::installer.product') }} Version {{ Config::get('installer::installer.version') }}</span>
</div>
